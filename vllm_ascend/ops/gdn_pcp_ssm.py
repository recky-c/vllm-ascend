...
#   6. All ranks take corrected[-1] (last valid rank via identity empty rows)
#      as decode final_state
#
...
def _recompute_local_h(
    *,
    ...
    causal order; decode end-state comes from the chained ``corrected[-1]``.
...
def correct_pcp_prefill_ssm_state(
    *,
    ...
    Returns:
        ...
        share the same decode ``final_state`` (``corrected[-1]``).
    """
