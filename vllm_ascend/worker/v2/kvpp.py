        ...
        if execution_layers is None:
            ...
            for layer_name in layers:
                ...
                if layer_index in claimed_indices:
                    raise ValueError(f"KVPP received multiple executable attention layers for transformer layer {layer_index}.")
...
class KVPPRuntime:
    ...
    def _placement(
        ...
        cache_group_index = get_kvpp_managed_group_index(
            kv_cache_config.kv_cache_groups, layer_owners
        )
    ...
    def _assemble(
        ...
        *,
        ...
        kvpp_impls = _collect_kvpp_attention_impls(
            static_forward_context, layer_owners
        )
    ...
    def try_build_v1(
        ...
        *,
        ...
        return cls._assemble(
            ...
            num_kernel_blocks=(
                kv_cache_config.num_blocks * block_table.blocks_per_phys_block
            ),
