...
class NPUWorker(WorkerBase):
    ...
    def initialize_from_config(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        # MRV2 emits new_block_ids_to_zero whenever the cache config requests
        # it. MRV1 retains its narrower Eagle3 condition.
        ...
        # Keep bookkeeping outside the sleep-mode cache pool so it survives
        # sleep/wake cycles.
