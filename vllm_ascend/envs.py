...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    "ASCEND_KVPP_MTE_STAGING_BYTES": lambda: int(
        os.getenv("ASCEND_KVPP_MTE_STAGING_BYTES", str(256 << 20))
    ),
    ...
    "ASCEND_KVPP_MTE_TIMEOUT_SECONDS": lambda: int(
        os.getenv("ASCEND_KVPP_MTE_TIMEOUT_SECONDS", "120")
    ),
}
